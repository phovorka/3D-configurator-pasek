...
var WatchConfigurator = function () {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "watch-configurator", children: [(0, jsx_runtime_1.jsx)("h3", { className: "title", children: "3D Konfigur\u00E1tor p\u00E1sku" }), (0, jsx_runtime_1.jsx)("model-viewer", { ref: modelRef, src: "https://cdn.jsdelivr.net/gh/phovorka/GLB/watch1.glb", "camera-controls": true, "auto-rotate": true }), " as any;", (0, jsx_runtime_1.jsx)("div", { className: "color-picker", children: ['black', 'brown', 'blue', 'red'].map(function (color) { return ((0, jsx_runtime_1.jsx)("button", { className: "color-button", style: { backgroundColor: color }, onClick: function () { return changeColor(color); } }, color)); }) })] }));
};
